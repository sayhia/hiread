...
/** Resolve a stored highlight colour key to its strong swatch colour — the
 *  same value the toolbar picker/filter dots use, so other consumers (the
 *  highlight card's colour spine) stay pixel-identical to those dots. */
