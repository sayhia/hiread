...
// and the result is injected via v-html inside a Wails webview — so every
// render is passed through an allowlist sanitizer first.
//
// Framework-agnostic sanitizer.
